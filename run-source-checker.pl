...
$sourcepages{"HuffPost Politics"} = ${$fb->query->find("/${$fb->fetch('/HuffPostPolitics')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
$sourcepages{"HuffPost Women"} = ${$fb->query->find("/${$fb->fetch('/HuffPostWomen')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
...
$sourcepages{"CNNMoney"} = ${$fb->query->find("/${$fb->fetch('/CNNMoney')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
$sourcepages{"CNN International"} = ${$fb->query->find("/${$fb->fetch('/CNNInternational')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
$sourcepages{"CNN Politics"} = ${$fb->query->find("/${$fb->fetch('/CNNPolitics')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
...
$sourcepages{"VICE News"} = ${$fb->query->find("/${$fb->fetch('/VICEnews')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
...
$sourcepages{"ABC News Politics"} = ${$fb->query->find("/${$fb->fetch('/ABCNewsPolitics')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
...
$sourcepages{"PBS News Hour"} = ${$fb->query->find("/${$fb->fetch('/newshour')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
...
$sourcepages{"the Business Insider"} = ${$fb->query->find("/${$fb->fetch('/businessinsider')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
$sourcepages{"Newsweek"} = ${$fb->query->find("/${$fb->fetch('/newsweek')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
$sourcepages{"Breaking News"} = ${$fb->query->find("/${$fb->fetch('/BreakingNews')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
$sourcepages{"the AP"} = ${$fb->query->find("/${$fb->fetch('/APNews')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
$sourcepages{"Reuters"} = ${$fb->query->find("/${$fb->fetch('/Reuters')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
$sourcepages{"CNBC"} = ${$fb->query->find("/${$fb->fetch('/cnbc')}{id}/feed")->select_fields(qw(id name link message created_time))->where_since("-$time minutes")->request->as_hashref}{data};
